 ...
 * @generated */
public class Exclude extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Exclude.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Exclude() {/* intentionally empty block */}
   ...
   */
  public Exclude(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Exclude(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
