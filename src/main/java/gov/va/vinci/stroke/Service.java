...
import gov.va.vinci.stroke.pipeline.BasePipeline;
...
public class Service {
    ...
    public static void main(String[] args) {
        gov.va.vinci.stroke.Service current_service = new gov.va.vinci.stroke.Service();
        
        if (args.length == 0) {
            current_service.serviceConfigFile = new File[]{new File("config/ServiceConfig.groovy")};
            current_service.pipeline = new String[]{"gov.va.vinci.stroke.pipeline.Pipeline"};
    ...
    public static void printUsage() {
        CmdLineParser parser = new CmdLineParser(new gov.va.vinci.stroke.Service());
        System.out.print("Usage: java " + gov.va.vinci.stroke.Service.class.getCanonicalName());
    ...
    public void run() {
      ...
      /* create type system */
            ...
            aggregate.setName("ColonoscopyADR_Service");
